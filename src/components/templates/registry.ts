...
// mapea CSS/JSX; cubierto por e2e). Los 2 templates que faltan (PORTFOLIO,
// TIENDA) apuntan a Landing temporalmente — cada slice siguiente reemplaza
// una entrada (ver Migration/Rollout en design.md).
