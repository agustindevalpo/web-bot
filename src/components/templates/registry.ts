...
// mapea CSS/JSX; cubierto por e2e). Los 3 templates que faltan (PORTFOLIO,
// RESTAURANTE, TIENDA) apuntan a Landing temporalmente — cada slice
// siguiente reemplaza una entrada (ver Migration/Rollout en design.md).
