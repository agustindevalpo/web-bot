...
// SERVICIOS no incluye galería (Decisión D6: "no gallery") y agrega un CTA
// de reserva por WhatsApp junto al contacto.
...
export type ServicioItem = { numero: number; texto: string }

export type ServiciosProps = { etiqueta: string; items: ServicioItem[] }
...
const ETIQUETA_SERVICIOS = 'Servicios'
